...
export default {
    name: "transactionLineChartGroups",
    ...
    computed: {
         ...mapState({
             type: (state) => state.transactionsModule.type,
            transactions: (state) => state.transactionsModule.transactions,
             currentPagetransactions: (state) =>
                state.transactionsModule.transactionPagination.page,
            totalrowsPerPagetransactions: (state) =>
                state.transactionsModule.transactionPagination.rowsPerPage,
            totaltransactions: (state) => state.transactionsModule.totaltransactions,
            transactionSortRowsBy: (state) => state.transactionsModule.transactionSortRowsBy,
        }),
        numberOfPages() {
    ...
    methods: {
        async getTransactions() {
            return new Promise((resolve, reject) => {
                ...
                this.$store
                .dispatch("transactionsModule/GET_TRANSACTIONS_ACTION", pagination)
                .finally(() => {
                    this.loading = false;
                });
    ...
    watch: {
        ...
        totalrowsPerPagetransactions(val){
            this.page = 1;
